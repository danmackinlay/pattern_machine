...
parser.add_argument('--non-cached', dest='cached', action="store_false",
    help='clobber any cached data')
...
def main(
    ...
    #tree = BallTree(wavdata['all_corrs'].T, metric='manhattan') # l1 wins
...
if __name__ == '__main__': 
    ...
    main(args.infile,
        ...
        ps_correl_port=args.ps_correl_port,
        # n_results=args.n_results,
        sc_synth_port=args.sc_synth_port,
