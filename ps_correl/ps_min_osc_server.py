...
sc_synth_client.connect( ("127.0.0.1", SC_SYNTH_PORT))
...
sc_synth_facing_server.addMsgHandler("/status.reply", sc_synth_facing_server.handle_blurt)

sc_synth_client.send(OSCMessage("/notify", 1))
